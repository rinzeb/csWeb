module PropertyTypes {
    /**
      * Config
      */
    var moduleName = 'csWeb.propertyTypes';
    ...
    myModule.directive('propertytypes', [ '$compile',
        function($compile): ng.IDirective {
            return {
                ...
                template  : html,       // I use gulp automatian to compile the PropertyTypes.tpl.html to a simple TS file, PropertyTypes.tpl.ts, which contains the html as string. The advantage is that you can use HTML intellisence in the html file.
